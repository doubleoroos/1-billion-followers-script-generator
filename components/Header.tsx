    ...
    <header className="bg-blue-darker/30 backdrop-blur-xl border-b border-white/5 sticky top-0 z-50 animate-fade-in">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        {showStartOver && (
          <button
            onClick={onStartOver}
            className="btn-3d flex items-center justify-center gap-2 bg-gradient-neutral text-rose-gray font-semibold py-2 px-4 rounded-full border border-white/10 animate-fade-in"
          >
