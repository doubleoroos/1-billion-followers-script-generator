...
export const Header: React.FC<HeaderProps> = ({ onStartOver, showStartOver }) => {
  return (
    <header className="bg-cyan/10 backdrop-blur-xl border-b border-white/20 sticky top-0 z-50 animate-fade-in">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        {showStartOver && (
          <button
            onClick={onStartOver}
            className="btn-glass flex items-center justify-center gap-2 bg-white/5 text-text-primary font-semibold py-2 px-4 rounded-full border border-white/10 animate-fade-in"
          >
