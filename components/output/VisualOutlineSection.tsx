            ...
            <div className="bg-black/80 border-b border-white/10 p-3 flex flex-col md:flex-row md:justify-between items-start md:items-center gap-4 md:gap-0">
                <div className="flex items-center gap-4 flex-grow w-full md:w-auto">
                    ...
                    <div className="flex-grow max-w-xl">
                        ...
                        <div className="font-mono text-[10px] text-slate-500 mt-2 flex items-center gap-3 bg-black/30 border border-white/5 px-2 py-1 rounded-sm w-fit flex-wrap">
                ...
                <div className="flex bg-black p-0.5 rounded-sm border border-white/20 flex-shrink-0 shadow-inner w-full md:w-auto justify-center mt-4 md:mt-0">
                    <button 
