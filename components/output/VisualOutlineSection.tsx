                    ...
                    <div className="flex flex-col gap-1 h-full"> {/* Studio Spacing: gap-1 */}
                        ...
                        <div className="input-studio p-2 rounded-sm flex-grow flex flex-col">
                            ...
                            <textarea
                                ...
                                className="w-full bg-transparent border-none p-0 text-slate-300 font-mono text-[10px] resize-none focus:ring-0 leading-relaxed flex-grow placeholder-slate-600 transition-colors"
...
```
  ...
  <change>
    <file>components/InputPanel.tsx</file>
    <description>Enhanced the competition badge to visually signify "Official Selection", elevating project prestige as per Senior UX instructions.</description>
    ...
    <div className="max-w-6xl mx-auto pb-32 md:pb-24"> {/* Adjusted padding for better balance */}
        <div className="text-center mb-16 space-y-4 pt-10">
            ...
            <div className="flex flex-col items-center gap-4">
                <p className="text-cyan-400 font-display text-lg md:text-xl uppercase tracking-[0.2em] font-bold drop-shadow-md">
            ...
            <div className="h-0.5 w-24 bg-cyan-500/50 mx-auto shadow-[0_0_10px_#06b6d4] mt-6"></div>
            <p className="font-mono text-slate-500 text-sm tracking-wider uppercase mt-2">
