...
import { EmptyStateStudio } from '../ui/EmptyStateStudio';
                ...
                <div className="relative w-full aspect-[2.39/1] overflow-hidden bg-slate-950">
                     {image.imageUrl ? (
                        <>
                         ...
                         <EmptyStateStudio message="WAITING FOR SIGNAL" className="border-none" />
                     )}
                </div>
                ...
                <div className="p-4 border-t border-white/5 bg-gunmetal relative">
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <p className="font-mono text-[12px] text-cyan-600 mt-1 uppercase tracking-[0.15em] font-bold">Film Still /// 8K Reference</p>
                        </div>
